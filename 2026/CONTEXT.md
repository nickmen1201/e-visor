...
- **"Real time" is a promise the pipeline cannot keep.** There is no continuous ingest: IND-15 is computed on the last loaded hour, and the dashboard must say which hour that is.
